  ...
  mainPanel(
    ...
    tabsetPanel(
      ...
      tabPanel("Histogram",HTML
               ("<div><h3> Histograms graphically depict the personalities of peoples' opinion about of the hashtag
                 </h3></div>"), plotOutput("histExtra"), plotOutput("histAgree"), plotOutput("histOpen"), plotOutput("histCons"), plotOutput("histNeuro")
               ),
      
      
      tabPanel("Pie Chart",HTML("<div><h3>Pie Chart</h3></div>"), plotOutput("piechart"), plotOutput("piechar"),HTML
               ("<div><h4> A pie chart is a circular statistical graphic, which is divided into slices to illustrate the personality of the hashtag. In a pie chart, the arc length 
                 of each slice (and consequently its central angle and area), is proportional to the quantity it represents.</h4></div>")
               
               ),
      
      tabPanel("Bar Plot",HTML("<div><h3>Bar Plot </h3></div>"), plotOutput("barplot"),HTML
               ("<div><h4>A bar chart or bar graph is a chart or graph that presents categorical data with rectangular bars with heights or lengths proportional to the values that they represent. The bars can be plotted vertically or horizontally.</h4></div>")
               
               ),
      
      tabPanel("Table",HTML( "<div><h3> Depicting sentiment in a tablular form on a scale of 5 </h3></div>"), tableOutput("tabledata"),
               HTML ("<div><h4> The table depicts the personality (extraversion, openness , agreeablesness,conscientiousness and neuroticism) of the tweets 
